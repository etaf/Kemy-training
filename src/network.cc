...
Network<SenderType1, SenderType2>::Network( Link link,const SenderType1 & example_sender1,
...
void Network<SenderType1, SenderType2>::run_simulation( const double & duration )
{
  ...
  while ( _tickno < duration ) {
    ...
    /*cout<<"===================="<<endl;*/
    //double t1 = _senders.next_event_time(_tickno);
    //cout<< "sender: "<<t1<<endl;
    //double t2 = _link.next_event_time(_tickno);
    //cout<< "link: "<<t2<<endl;
    //double t3 = _delay.next_event_time(_tickno);
    //cout<< "delay "<<t3<<endl;
    //double t4 = _rec.next_event_time(_tickno);
    //cout<<"rec: "<<t4<<endl;

    //cout<<"tickno= "<<_tickno<<endl;
    /*cout<<"===================="<<endl;*/
