...
public:
  ...
  Whisker( const unsigned int s_window_increment, const double s_window_multiple, const MemoryRange & s_domain );
  ...
  bool operator==( const Whisker & other ) const { return (_window_increment == other._window_increment) && (_window_multiple == other._window_multiple) && (_domain == other._domain); }
